...
//        viewForHeader.addGestureRecognizer(UITapGestureRecognizer(target: self, action: #selector(handleOpen)))
//        return viewForHeader
//        
//    }
//    @objc func handleOpen(_ sender: UITapGestureRecognizer){
//        if let view = sender.view as? ViewForHeader{
...
//        }
//        
////        sender.vi .opened = !sender.opened
//        
//    }
//    @objc func handleTap(){
