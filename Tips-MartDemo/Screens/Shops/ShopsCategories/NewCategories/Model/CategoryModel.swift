...
class CategoryModel{
    ...
    var onlineIfflineArray: [CategoriesAdapter] = [CategoriesAdapter(categoryID: 0, name: "Онлайн", subCategories: [], switchTable: .closed), CategoriesAdapter(categoryID: 0, name: "Оффлайн", subCategories: [], switchTable: .closed), CategoriesAdapter(categoryID: 0, name: "Все магазины", subCategories: [], switchTable: .closed) ]
