...
//  Tips-MartDemo
//
//  Created by Andrey Petrovskiy on 4/5/19.
...
//        self.placeHolderLabel.font = UIFont(name: "System", size: 5)
//        self.placeHolderLabel.frame = CGRect(x: self.placeHolderLabel.frame.origin.x, y : 0, width :textField.frame.size.width, height : textField.frame.size.height)
//    }
//    else {
//        //                if self.directionMaterial == placeholderDirection.placeholderUp {
//        self.placeHolderLabel.frame = CGRect(x : self.placeHolderLabel.frame.origin.x, y : CGFloat(-self.difference), width : textField.frame.size.width, height : textField.frame.size.height)
//    }
//    //            else {
